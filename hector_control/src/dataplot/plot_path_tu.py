...
dfl.append(pd.read_csv(f'{path_d}/datapose-s2-{21}-{18}-fa1-fr0.5.csv', delimiter=','))
...
s_size = 5
plt.plot(x[0],y[0], label=f"Time = {t[0][-1]-t[0][0]}")
plt.plot(x[1],y[1], label=f"Time = {t[1][-1]-t[1][0]}")
plt.plot(x[2],y[2], label=f"Time = {t[2][-1]-t[2][0]}")
