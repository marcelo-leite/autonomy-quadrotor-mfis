...
path_d = str(cwd) + "/../database/test/tfr"

dfl.append(pd.read_csv(f'{path_d}/datapose-s1-{21}-{18}-fa0.5-fr0.25.csv', delimiter=','))
dfl.append(pd.read_csv(f'{path_d}/datapose-s1-{21}-{18}-fa0.5-fr0.5.csv', delimiter=','))
dfl.append(pd.read_csv(f'{path_d}/datapose-s1-{21}-{18}-fa0.5-fr0.75.csv', delimiter=','))
dfl.append(pd.read_csv(f'{path_d}/datapose-s1-{21}-{18}-fa0.5-fr1.csv', delimiter=','))
...
s_size = 5
plt.plot(x[0],y[0], label="Fr = 0.25")
plt.plot(x[1],y[1], label="Fr = 0.50")
plt.plot(x[2],y[2], label="Fr = 0.75")
plt.plot(x[3],y[3], label="Fr = 1.00")
