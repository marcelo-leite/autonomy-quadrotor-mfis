...
class ObstacleAvoid:
    def __init__(self, d_min, d_max):
        ...
        yS = mb.gaussmf(xo, [ko, xo[0]]) + mb.gaussmf(xo, [ko, xo[-1]])
        ySE =  mb.gaussmf(xo, [ko, xo[0] - k_sb])
        yE = mb.gaussmf(xo, [ko, xo[0] - 2*k_sb])
        yNE = mb.gaussmf(xo, [ko, xo[0] - 3*k_sb])
        yN = mb.gaussmf(xo, [ko,  xo[0] - 4*k_sb])   
        yNO = mb.gaussmf(xo, [ko, xo[0] - 5*k_sb])
        yO = mb.gaussmf(xo, [ko, xo[0] - 6*k_sb])
        ySO = mb.gaussmf(xo, [ko, xo[0] - 7*k_sb])
